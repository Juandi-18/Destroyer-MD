...
export default {
  ...
  run: async ({ msg, sock, args, usedPrefix, command }) => {
    ...
    return sock.sendMessage(msg.chat, { text: actual && actual !== nuevo ? `✿ El dueño del sokect ha sido cambiado de @${ownerActual} a @${ownerNuevo}!` : `❀ Se asignó a @${ownerNuevo} como nuevo propietario de *${config.namebot || 'Destroyer'}*!`, mentions: [nuevo, ...(actual && actual !== nuevo ? [actual] : [])] }, { quoted: msg });
  },
};