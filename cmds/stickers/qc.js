...
export default {
  ...
  run: async ({ msg, sock, args, usedPrefix, command, text }) => {
    try {
      ...
      // MODIFICACIÓN: Límite aumentado a 40 caracteres
      if (textFinal.length > 40) {
        await msg.react('✖️');
        return sock.reply(msg.chat, `《✧》 El texto no puede tener más de 40 caracteres.`, msg);
      }
      ...
      let texto1 = meta1 ? meta1 : 'ᴅᴇsᴛʀᴏʏᴇʀ 🧠 Wᴀʙᴏᴛ';
