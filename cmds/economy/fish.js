  ...
  run: async ({ msg, sock, usedPrefix, text }) => {
    ...
    if (rand < 0.4) {
      ...
      const successMessages = [
        `¡Has pescado un Salmón con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has pescado una Trucha con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has capturado un Tiburón con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has pescado una Ballena con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has capturado un Pez Payaso con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has atrapado una Anguila Dorada con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has pescado un Mero Gigante con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has capturado un Pulpo azul con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Sacaste una Carpa Real con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`,
        `¡Has conseguido un Pez Dragón con tu Caña! Ganaste *¥${cantidad.toLocaleString('en-US')} ${currency}*!`
      ];
      ...
      const failMessages = [
        `El anzuelo de tu Caña se enredó y perdiste parte de tu equipo, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`,
        `Una corriente fuerte arrastró tu Caña, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`,
        `Un pez grande rompió tu línea de la Caña y dañó tu aparejo, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`,
        `Tu bote se golpeó contra las rocas y tuviste que reparar tu Caña, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`,
        `El pez escapó y arruinó tu red conectada a tu Caña, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`,
        `El pez mordió el anzuelo pero se soltó y dañó tu carrete de la Caña, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`,
        `Tu cubeta se volcó y los peces atrapados con tu Caña se perdieron, perdiste *¥${cantidad.toLocaleString('en-US')} ${currency}*.`
      ];
