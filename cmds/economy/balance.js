...
export default {
  ...
  ⛀ Cartera › *¥${(user.coins != null ? user.coins.toLocaleString('en-US') : 0)} ${monedas}*
  ⚿ Banco › *¥${(user.bank != null ? user.bank.toLocaleString('en-US') : 0)} ${monedas}*
  ⛁ Total › *¥${total.toLocaleString('en-US')} ${monedas}*
