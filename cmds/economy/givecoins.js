...
export default {
  ...
  run: async ({ msg, sock, args, usedPrefix, command, text }) => {
    ...
    await sock.sendMessage(chatId, { text: `❀ Transferiste *¥${cantidad.toLocaleString('en-US')} ${monedas}* a *${name}*\n> Ahora tienes *¥${(senderData.bank - cantidad).toLocaleString('en-US')} ${monedas}* en tu banco.`, mentions: [who] }, { quoted: msg });
  }
};